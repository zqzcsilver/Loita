using Loita.StringDrawerSystem.DrawerItems;
...
namespace Loita.StringDrawerSystem
{
    internal class StringDrawer
    {
        ...
        private List<Vector2> _lineSize = new List<Vector2>();
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else if (text[i] == ']' && dIndex != -1)
                            {
                                ...
                                var d = DrawerItemManager.Instance.GetDrawerItem(this, text[dIndex..(i + 1)], drawerName, stringParameters, line);
