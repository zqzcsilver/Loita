...
namespace Loita.Utils
{
    internal class StringUtil
    {
        ...
        /// <param name="scale"></param>
        /// <returns></returns>
        public static List<string> WordWrap1(string text, FontStashSharp.DynamicSpriteFont font, float width, float scale = 1.0f)
        {
            if (string.IsNullOrEmpty(text))
                return null;
            List<string> output = new List<string>();
            ...
            {
                var x = text.Split('\n');
                Array.ForEach(x, x => output.AddRange(WordWrap1(x, font, width, scale) ?? new List<string>()));
                return output;
            }
        ...
        /// <param name="scale"></param>
        /// <returns></returns>
        public static List<string> WordWrap1(string text, FontStashSharp.SpriteFontBase font, float width, float scale = 1.0f)
        {
        ...
        public static string GetWordWrapString1(string text, FontStashSharp.DynamicSpriteFont font, float width, float scale = 1.0f)
        {
            StringBuilder stringBuilder = new StringBuilder();
            var words = WordWrap1(text, font, width, scale);
            if (words == null)
                return string.Empty;
        ...
        public static string GetWordWrapString1(string text, FontStashSharp.SpriteFontBase font, float width, float scale = 1.0f)
        {
            StringBuilder stringBuilder = new StringBuilder();
            var words = WordWrap1(text, font, width, scale);
            if (words == null)
