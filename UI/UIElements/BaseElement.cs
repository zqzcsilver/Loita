...
namespace Loita.UI.UIElements
{
    internal class BaseElement
    {
        ...
        public static BaseElement CreateFullElement()
        {
        ...
        protected virtual void DrawChildren(SpriteBatch sb)
        {
            ...
            //sb.Draw(Terraria.GameContent.TextureAssets.MagicPixel.Value, GetCanHitBox(), Color.White * 0.1f);
            //sb.DrawString(Loita.DefaultFontSystem.GetFont(20f), GetType().Name, GetCanHitBox().Location.ToVector2(), Color.Red);
        }
        ...
        public virtual bool ContainsPoint(Point point) =>
            (GetParentElementIsHiddenOverflow() ? GetCanHitBox() : HitBox).Contains(point);
